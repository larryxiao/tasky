...
# <https://cloud.google.com/console#/project/995681773719/apiui>
CLIENT_SECRETS = os.path.join(tasky_dir, 'client_secrets.json')
...
def authenticate():
  ...
  storage = file.Storage(os.path.join(tasky_dir, 'tasks.dat'))
